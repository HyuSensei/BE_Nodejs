...
router.post("/users/update", middleware.checkPremission, userController.updateUser);
router.delete("/users/:id", middleware.checkPremission, userController.destroyUser);
...
router.get("/categories/sale", middleware.checkPremission, categoryController.getCategoriesSale);
...
router.get("/statistics", middleware.checkPremission, orderController.getStatistics);
router.get("/statisticsByMonht", middleware.checkPremission, orderController.getStatisticsByMonht);
router.get("/statisticsByYear", middleware.checkPremission,  orderController.getStatisticsByYear);
...
// order product desc
router.get("/order_product/desc", middleware.checkPremission, order_productController.getAllByDESC);
router.get("/order_product", middleware.checkPremission, order_productController.getAll);
...
//dung de phan trang
router.get("/prodouct/count", middleware.checkPremission, productController.getCountProduct);
router.get("/prodouct/limit/:currentPage", middleware.checkPremission, productController.getProductLimit);
